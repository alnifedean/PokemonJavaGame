...
public class BugPokemon extends Pokemon implements IBug {

  public BugPokemon(int numPokemon, String name, String type, int hp, int strength, String strongTo1, String strongTo2, String strongTo3, String strongTo4, String strongTo5, String strongTo6, String strongTo7){ 
  ...
  @Override
  public int BugAttack(String typeP) {
  ...
  public void attack(Pokemon poke, int atkTypeSel) {
    ...
    if(atkTypeSel==1){
      int typeDamage = BugAttack(typeP);
