...
import Interf.IDragon;

public class DragonPokemon extends Pokemon implements IDragon {
  ...
  @Override
  public int DragonAttack(String typeP) {
  ...
  public void attack(Pokemon poke, int atkTypeSel) {
    ...
    if(atkTypeSel==1){
      int typeDamage = DragonAttack(typeP);
